...
public class ManageUserDAO implements UserDAO {
    ...
    @Override
    public NewRegisteredUser saveNewInfo(int id, String firstName, String lastName, String username, String password, String phoneNumber) {



        try (Connection connection = controller.getConnection()) {
            PreparedStatement statement = connection.prepareStatement(
                    "UPDATE public.users SET firstname='"+firstName+"',lastname='"+lastName+"',username='"+username+"',password='"+password+"',phonenumber='"+phoneNumber+"' where id='"+id+"'");
    ...
    @Override
    public NewRegisteredUser createUser(String firstName,
