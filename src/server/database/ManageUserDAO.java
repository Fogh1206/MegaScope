    ...
    public ArrayList<Movie> getAllMovies() {
        ...
        try (Connection connection = controller.getConnection()) {
            ...
            while (resultSet.next()) {
                ...
                Movie temp = new Movie(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6));
