...
public class UserReservationViewModel implements PropertyChangeSubject {
    ...
    public UserReservationViewModel(UserModel model) {
        ...
        model.addPropertyChangeListener(EventType.GETUSERRESERVATIONS_RESULT.toString(), this::onGetReservations);
    }
    ...
    public void onGetReservations(PropertyChangeEvent event) {
        UserReservationInfoList userReservationInfos = (UserReservationInfoList) event.getNewValue();
